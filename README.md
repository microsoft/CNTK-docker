...
* `2.0.beta7.0-runtime-gpu-python3.4-cuda8.0-cudnn5.1`, `latest` ([/ubuntu-14.04/version_2/2.0.beta7.0/gpu/runtime/Dockerfile](https://github.com/Microsoft/CNTK-docker/blob/v2.0.beta7.0/ubuntu-14.04/version_2/2.0.beta7.0/gpu/runtime/Dockerfile))
